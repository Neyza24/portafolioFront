    ...
    <div className="home__data">
      ...
      <h5>
        ...
        <svg
          ...
          className="home__hand-small move"
        >
          <path
      ...
      <h1 className="home__title">Neyza Vargas</h1>

      <p className="home__description">
        <span className="home__rol">Front-end Web Developer </span>
        en constante aprendizaje. Creo que tanto lo creativo y lógico pueden coexistir a la vez.
      </p>
